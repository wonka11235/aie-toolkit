...
### Welcome!
This is my attempt to keep all of the various AI resources that I come across in a single place. When I add something here, I will annotate the resource with some notes/takeaways. I use this locally as an [Obsidian](https://obsidian.md) vault, with the vault-specific files listed in my gitignore. I created this to track my own AI Engineering journey, but you are welcome to follow along!
